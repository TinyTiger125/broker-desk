...
- `TASK-040 / W9` 当前为 `In Progress`；W9.1已 `Accepted / Runtime Verified`，覆盖资料负责人、membership＋成员＋对象类型默认值、旧数据安全默认和跨经营主体隔离基础。W9.2页面读写、定向分享、共同编辑、资料接管、完整来源权限/PDF链路仍未开始；Production不连接、不迁移。
