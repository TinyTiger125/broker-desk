...
- `TASK-018 / MIG-007` 已进入实施：产品负责人批准 A→独立审查→B→独立审查；A 的 TASK-003 实现、独立审查和本地浏览器/数据行为门禁已通过，B 尚未开始。
...
- 范围安全：MIG-006 本身未产生业务代码差异；MIG-007 A 只新增非生产显式 demo 身份门禁修复，并保留已审查的 TASK-003 资料确认/合并交互；未修改数据库、safety/WIP、main、TASK-004～008、149 项分类或术语目录。治理记录更新仅涉及 TASK-018、恢复矩阵、BACKLOG 和本交接。
...
- TASK-003 的 A 本地运行门禁已通过；TASK-004 前台流程 B 尚未开始，必须保持独立范围和独立审查。真实 OCR、生产认证、外部服务、生产数据库和隧道仍需人工验证。149 项专业分类、TASK-005～008 不得顺手迁入；MIG-007 完成后停止新增治理任务。
