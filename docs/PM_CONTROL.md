...
| --- | --- | --- | --- | --- |
| PM-001 | PM | Done | Establish multi-agent operating model | `docs/PM_CONTROL.md` |
...
| PM-004 | PM | Done | Define V1 input file model from broker source templates | `docs/V1_INPUT_FILE_MODEL.md` |
...
| PM-005 | PM | Done | Capture template variation strategy and AI supplement boundary | `docs/V1_INPUT_FILE_MODEL.md` |
| PM-006 | PM | Done | Replace user-facing mapping concept with broker-friendly review workflow | `docs/V1_INPUT_FILE_MODEL.md` |
...
| PM-007 | PM | Done | Decide Review/Save architecture with BrokerageCase and ExtractionReview | `docs/V1_INPUT_FILE_MODEL.md` |
...
| PM-008 | PM | Done | Re-scope V1 output to guarantee company application forms | `docs/V1_GUARANTEE_APPLICATION_OUTPUT.md` |
...
| PM-010 | PM | Done | Define editable case workbench as missing middle layer | `docs/V1_CASE_WORKBENCH.md` |
| PM-011 | PM | Done | Define product topology and priority rule | `docs/PRODUCT_TOPOLOGY.md` |
...
| PM-013 | PM | Done | Define missing-field navigation from output readiness to editable workbench/draft | `docs/V1_CASE_WORKBENCH.md` |
...
| PM-014 | PM | Done | Define anti-Salesforce frontstage simplification rule | `docs/PRODUCT_TOPOLOGY.md` |
...
| PM-015 | PM | Done | Convert high-usability objection into hard frontstage acceptance criteria | `docs/PRODUCT_TOPOLOGY.md` |
...
- `docs/PM_CONTROL.md`
- `docs/V1_INPUT_FILE_MODEL.md`
- `docs/V1_GUARANTEE_APPLICATION_OUTPUT.md`
...
See `docs/V1_GUARANTEE_APPLICATION_OUTPUT.md`.
...
See `docs/V1_INPUT_FILE_MODEL.md`.
