-- Rollback for 20260921_001_supabase_auth_lifecycle.sql. UNEXECUTED.
-- Apply only after explicit product approval and a matching migration ledger review.
-- This restores the prior none/manual/clerk provider boundary.
