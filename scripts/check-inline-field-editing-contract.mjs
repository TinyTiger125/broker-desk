...
if (!page.includes("initialValue={objectImportBinding?.candidateValue ?? field.value}")) throw new Error("row form must seed the value snapshot from the candidate or saved value");
