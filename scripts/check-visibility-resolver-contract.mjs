...
assert(partyNewPage.includes('requireTenantSession({ permission: "record.update" })') && partyNewPage.includes("createClientFormAction"), "person creation route requires record.update before exposing the current creation contract");
