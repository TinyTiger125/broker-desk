...
mustInclude(formsEditPage, ["requireTenantSession", "template.edit_draft", "GuaranteeSlice1Client", "listBrokerageCases", "initialMaskVersionId", "initialBlankFormVersionId", "initialMaskId", "requestedVersion", "recoveryBlankFormVersionId", "recoveryMaskId", "selectedVersion", "no matching saved version exists", "loadInitialAdminContext", "readPrivateAttachmentContentForTenant", "blankPagePngBase64", "表格恢复失败，请稍后重试", "randomUUID", "if (!enabled)", "既有申请书路径不受影响", "activeVersionId !== blankVersion.id"], "formal editor access contract");
