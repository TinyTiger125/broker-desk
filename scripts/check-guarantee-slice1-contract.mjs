...
mustInclude(formsEditPage, ["requireTenantSession", "template.edit_draft", "GuaranteeSlice1Client", "initialMaskVersionId", "initialBlankFormVersionId", "initialMaskId", "requestedVersion", "shouldLoadExplicitUpload", "selectedVersion", "no matching saved version exists"], "formal editor access contract");
