...
mustInclude(formsPage, ["getLocale", "locale={locale}"], "forms locale contract");
...
if (!postgresFallback || /INSERT INTO|UPDATE |createGuaranteeCompanyMask|addGuaranteeCompanyMaskVersion/.test(postgresFallback)) throw new Error("postgres fallback mask lookup must remain read-only");
