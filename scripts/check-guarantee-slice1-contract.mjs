...
mustInclude(formsEditPage, ["requireTenantSession", "template.edit_draft", "GuaranteeSlice1Client", "initialMaskVersionId", "initialBlankFormVersionId", "initialMaskId", "hasRequestedContext", "stale draft can make the editor load the wrong mask"], "formal editor access contract");
