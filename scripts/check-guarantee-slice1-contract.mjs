...
mustInclude(formsClient, ["UPLOAD_ERROR_MESSAGES", "Record<Locale", "PDFファイルを選択してください。", "PDFを読み取れません。ファイルが破損していないか確認して、もう一度アップロードしてください。", "暗号化またはパスワード保護されたPDFには対応していません。", "PDFファイルは10MB以下にしてください。", "現在は1ページのPDFのみ対応しています。", "ページ回転が設定されたPDFには対応していません。", "このPDFのページ裁切設定には対応していません。", "请选择PDF文件。", "无法读取该PDF。请确认文件未损坏后重新上传。", "暂不支持加密或密码保护的PDF。请解除保护后重新上传空白PDF。", "PDF文件不能超过10MB。", "第一版仅支持单页PDF。", "暂不支持带页面旋转设置的PDF。", "该PDF的页面裁切设置暂不支持。", "请求编号", "リクエスト番号", "explainUploadError"], "upload error UX contract");
