...
| TASK-031 | P0 | W7-A：物件创建/编辑 Responsive Form 参考迁移 | In Progress | TASK-030 | [TASK-031](docs/tasks/TASK-031.md) | Checkpoint A 产品复审通过；Checkpoint B 规格已写入 `TASK-031_W7A_TARGET_STRUCTURE_2026-08-18.md`，固定共同字段/校验/错误/returnTo、草稿冻结、lifecycle/关系边界、Responsive Form 和 PostgreSQL 最小适配；不启动实现或 Agent，等待规格复审 |
