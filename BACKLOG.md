...
| TASK-031 | P0 | W7-A：物件创建/编辑 Responsive Form 参考迁移 | In Progress | TASK-030 | [TASK-031](docs/tasks/TASK-031.md) | Checkpoint C 有限实现完成、静态检查通过、独立只读审查无 P0/P1；真实浏览器、响应式、键盘/焦点、PostgreSQL运行读写、权限/租户和完整无障碍仍未验证，等待 D-Lite/产品收口 |
