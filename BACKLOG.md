...
| TASK-023 | P0 | UI-GOV-003 案件 Object Page 参考实现 | In Review | TASK-022 | [TASK-023](docs/tasks/TASK-023.md) | 两个开发预览路由已移除；独立复验仍未取得修复后手动滚动 hash、键盘锚点和隔离模板下载确认/修改失效的正式浏览器证据；真实 Clerk/第二租户/生产环境另列发布门禁；TASK-020 继续 Blocked |
