...
| TASK-023 | P0 | UI-GOV-003 案件 Object Page 参考实现 | In Review | TASK-022 | [TASK-023](docs/tasks/TASK-023.md) | Checkpoint C 本地正式页部分通过，但手动滚动 hash 同步、键盘锚点、最终下载确认/修改失效及两个未保护开发预览路由仍未通过；真实 Clerk/第二租户/生产环境另列发布门禁；TASK-020 继续 Blocked |
