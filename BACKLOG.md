...
| TASK-029 | P0 | W6-B：主体索引 /parties List Report 参考迁移 | In Progress | TASK-028 | [TASK-029](docs/tasks/TASK-029.md) | Checkpoint C 有限实现和独立审查完成，代码 `8686d9a`；CSV 页面冻结、flash 仅短暂反馈；静态检查通过，浏览器/响应式/键盘仍 UNVERIFIED，等待产品负责人复审，不自动进入 D-Lite |
