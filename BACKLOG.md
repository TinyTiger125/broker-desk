...
| TASK-029 | P0 | W6-B：主体索引 /parties List Report 参考迁移 | In Progress | TASK-028 | [TASK-029](docs/tasks/TASK-029.md) | Checkpoint C 最终结构微调 `d0cf288` 和独立审查完成；页面标题/桌面表头/空态重复操作已修正，静态检查通过；D-Lite 因本地 Next.js `fs` 构建错误 UNVERIFIED，等待产品负责人最终收口 |
