...
| TASK-024 | P0 | UI-GOV-002B Broker Desk Layout System 建设 | In Review | TASK-023 | [TASK-024](docs/tasks/TASK-024.md) | 阶段 A 目标图已批准；阶段 C 已实现公共 Layout 组件和仅申请人 child 的 Responsive Form 试点，静态门禁通过，正式页面浏览器验收仍被 Clerk 测试身份阻断 |
