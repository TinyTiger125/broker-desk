...
| TASK-029 | P0 | W6-B：主体索引 /parties List Report 参考迁移 | In Progress | TASK-028 | [TASK-029](docs/tasks/TASK-029.md) | Checkpoint B 条件通过；CSV 页面能力已冻结并移除，flash 仅作短暂操作反馈，规格修正后授权进入一次有限实现和一次独立审查，不自动进入 D-Lite |
