...
| TASK-024 | P0 | UI-GOV-002B Broker Desk Layout System 建设 | In Review | TASK-023 | [TASK-024](docs/tasks/TASK-024.md) | 阶段 A 已提交申请人 Responsive Form 的 1440/768/390 目标图，等待产品确认；未改 `src/`，批准后才实现公共组合组件并以申请人章节试点 |
