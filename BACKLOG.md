...
| TASK-034 | P0 | W11-CORE：全产品 Layout System 核心对象与工作流结构收口 | Done | TASK-033 | [TASK-034](docs/tasks/TASK-034.md) | 第一批结构迁移完成：/clients/[id] Object Page、/service-requests Worklist、/audit-log 只读 List Report；/contracts 只读 Worklist，合同状态/金额/批量/导出因非权威来源冻结；专项契约、静态检查和独立复审通过，运行项因 listen EPERM 进入统一批次回归 |
