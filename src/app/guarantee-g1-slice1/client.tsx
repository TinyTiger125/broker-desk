    ...
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      {isAdmin && <section className="mt-8 border-t border-slate-200 pt-6" aria-labelledby="admin-title">
        ...
        {maskId && <div className="mt-6 border-t border-slate-200 pt-5">
          ...
          {blankPdfSrc && <div className="mt-5 grid gap-4 lg:grid-cols-[minmax(0,1fr)_18rem]">
            ...
            <aside className="text-sm text-slate-600"><p className="font-medium text-slate-900">人工校准</p><p className="mt-2 leading-5">字段框与固定 PDF 页面画布使用同一套 PDF points 坐标。浏览器缩放只改变显示，不改变保存坐标。</p><a className="mt-3 inline-block text-blue-700 underline" href={blankPdfSrc} target="_blank" rel="noreferrer">在新窗口查看客户空白 PDF</a></aside>
          </div>}
