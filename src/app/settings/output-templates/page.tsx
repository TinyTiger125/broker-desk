...
function getCopy(locale: Locale) {
  const copyByLocale = {
    ja: {
      ...
      opsMemo3: "文書番号・改訂記録・発行日は自動で記録されます。",
      saveSettings: "設定を保存",
      resetTemplate: "日本標準テンプレートを再適用",
      versionLabel: "改訂記録名（任意）",
      versionLabelPlaceholder: "例: 2026年4月書式調整",
      changeNote: "変更メモ（任意）",
      changeNotePlaceholder: "例: 注意文と会社情報を更新",
      versionsTitle: "テンプレート改訂履歴",
      versionsDesc: "保存時に調整内容を記録します。必要に応じて過去の記録へ戻せます。",
      activeVersion: "現在適用中",
      checkDiff: "差分を確認",
    ...
    zh: {
      ...
      opsMemo3: "文书编号、修订记录与出具日会自动记录。",
      saveSettings: "保存设置",
      resetTemplate: "恢复日本标准模板",
      versionLabel: "修订记录名（可选）",
      versionLabelPlaceholder: "例：2026年4月格式调整",
      changeNote: "变更备注（可选）",
      changeNotePlaceholder: "例：更新注意文与公司信息",
      versionsTitle: "模板修订记录",
      versionsDesc: "每次保存会记录本次调整，也可恢复到过去的记录。",
      activeVersion: "当前生效中",
      checkDiff: "查看差异",
      applyVersion: "应用此记录",
    ...
    ko: {
      ...
      opsMemo3: "문서 번호·수정 기록·발행일은 자동으로 기록됩니다.",
      saveSettings: "설정 저장",
      resetTemplate: "일본 표준 템플릿 재적용",
      versionLabel: "수정 기록명(선택)",
      versionLabelPlaceholder: "예: 2026년 4월 서식 조정",
      changeNote: "변경 메모(선택)",
      changeNotePlaceholder: "예: 주의문 및 회사 정보 업데이트",
      versionsTitle: "템플릿 수정 기록",
      versionsDesc: "저장 시 조정 내용을 기록합니다. 필요하면 이전 기록으로 되돌릴 수 있습니다.",
